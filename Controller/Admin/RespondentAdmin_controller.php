...
if (isset($_POST['email'], $_POST['username'], $_POST['password'])) {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if ($insert_login_result) {
            ...
            $insert_user_query = "INSERT INTO `scerns_user_details` (`Fullname`, `Email`, `User_id`,`Type`)
    ...
    $select_query = "SELECT login.*, scerns_user_details.* FROM scerns_login 
                     JOIN scerns_user_details ON scerns_login.Id = user_details.User_id
