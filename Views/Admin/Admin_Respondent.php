...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="modal fade" id="editRegistrarModal" tabindex="-1" role="dialog" aria-labelledby="editRegistrarModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
    ...
    < <script src="https://adminlte.io/themes/v3/plugins/jquery/jquery.min.js">
        ...
        <script>
            ...
            function addRespondentAdmin() {
                ...
                $.ajax({
                    url: '../../Controller/Respondent_Admin/RespondentAdmin_controller.php',
                    method: 'POST',
                    data: {
                        fullname: fullname,
                        email: email,
